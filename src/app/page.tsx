...
export default function Home() {
  ...
  return (
    <main className="flex min-h-dvh min-w-dvw flex-col max-h-dvh items-center p-3 md:p-0 overflow-y-hidden">
      <Youtube
      ...
      <section className="pb-3" id="metadata">
        <h1>{lyric.title}</h1>
        <p>{lyric.artist}</p>
      ...
      <div className="overflow-y-auto min-w-dvw">
        <ul ref={lyricsContianerRef} className="flex flex-col gap-y-5">
