...
import { PlayIcon, PauseIcon, LanguageIcon } from "@heroicons/react/24/solid";
...
type Params = { song: string };

export default function ClientLearnPage(props: { params: Params }) {
