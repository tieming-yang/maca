...
const baseClass = `${topGlowBorder} inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-semibold transition disabled:cursor-not-allowed disabled:opacity-60`;
...
const variantClassMap: Record<ButtonVariant, string> = {
  ...
  icon: "bg-teal-700 text-white enabled:hover:bg-teal-400 px-2 enabled:focus-visible:outline enabled:focus-visible:outline-offset-2 enabled:focus-visible:outline-teal-300 size-13",
  outline:
