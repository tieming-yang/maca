...
const baseClass = `inline-flex items-center justify-center rounded-full px-4 py-4 text-sm font-semibold transition disabled:cursor-not-allowed disabled:opacity-60 backdrop-blur-2xl`;

const variantClassMap: Record<ButtonVariant, string> = {
  primary:
    `${topGlowBorder} bg-zinc-900 text-white enabled:hover:bg-zinc-900 enabled:focus-visible:outline enabled:focus-visible:outline-offset-2 enabled:focus-visible:outline-zinc-300`,
  danger:
    `${topGlowBorder} border border-rose-500/60 text-rose-300 enabled:hover:bg-rose-500/10 enabled:focus-visible:outline enabled:focus-visible:outline-offset-2 enabled:focus-visible:outline-rose-400`,
